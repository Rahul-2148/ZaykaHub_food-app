...
const CustomerReviews = () => {
  const reviews = [
    ...
    { id: 6, name: "Arbaz Khan", comment: "Great customer service. 👍", rating: 4.9 },
    { id: 7, name: "Ahmad Salik Yazdani", comment: "Food quality is top-notch. 🌟", rating: 5 },
    { id: 8, name: "Mudassar Alam", comment: "Amazing food! Super fast delivery. 🔥", rating: 5 },
  ];
