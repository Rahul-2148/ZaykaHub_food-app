...
const createFrontendUrl = (path: string) =>
...
export const htmlContent = (
  ...
  const unsubscribeLink = createFrontendUrl(`/api/v1/user/unsubscribe/${email}`);
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <a href="${createFrontendUrl(`/api/v1/user/verify-email?token=${verificationToken}`)}" class="cta-button">Verify My Email</a>
      ...
      <div class="footer">
        ...
        <p>Need help? <a href="${createFrontendUrl("/contact")}">Contact Support</a></p>
        ...
        <div class="email-container">
          ...
          <div class="email-body">
            ...
            <p style="text-align: center;">
              <a href="${createFrontendUrl("/login")}" class="button">Log In Now</a>
            </p>
...
export const generateAccountDeletionEmailHtml = (
  ...
  const cancelDeletionLink = createFrontendUrl(`/cancel-deletion?userId=${userId}`);
      ...
      <body>
        <div class="email-container">
          ...
          <div class="email-body">
            ...
            <!-- Call to Action Button -->
            <div class="button-container">
              <a href="${createFrontendUrl("/")}" class="button">Go to Dashboard</a>
            </div>
      ...
      <body>
        <div class="email-container">
          ...
          <div class="email-body">
            ...
            <!-- Call to Action Button -->
            <div class="button-container">
              <a href="${createFrontendUrl(`/track-order?orderId=${orderId}`)}" class="button">Track Your Order</a>
            </div>
      ...
      <body>
        <div class="email-container">
          ...
          <div class="email-body">
            ...
            <!-- Call to Action Button -->
            <div class="button-container">
              <a href="${createFrontendUrl(`/order/status?orderId=${orderId}`)}" class="button">Give Feedback</a>
            </div>
      ...
      <body>
        <div class="email-container">
          ...
          <div class="email-body">
            ...
            <!-- Action Button -->
            <div class="button-container">
              <a href="${createFrontendUrl("/shop")}" class="button">Browse Products</a>
            </div>
      ...
      <body>
        <div class="email-container">
          ...
          <div class="email-body">
            ...
            <!-- Action Button -->
            <div class="button-container">
              <a href="${createFrontendUrl("/order/status")}" class="button">View Order Status</a>
            </div>
